...
BOARDNAME = $(call qstrip,$(BR2_TARGET_UBOOT_BOARD_DEFCONFIG))
...
ifneq ('$(BOARDNAME)','socfpga_arria10')
...
define UBOOT_ALTERA_INSTALL_STAGING_CMDS
    @echo ">>> Staging install commands $(UBOOT_ALTERA_STAGING_HANDOFF) $(BOARDNAME)"
