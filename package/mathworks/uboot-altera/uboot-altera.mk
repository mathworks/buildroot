...
UBOOT_ALTERA_STATING_TARGET = usr/share/uboot-altera
...
UBOOT_ALTERA_STAGING_HANDOFF = $(STAGING_DIR)/$(UBOOT_ALTERA_STATING_TARGET)/handoff
UBOOT_ALTERA_STAGING_GENERATED = $(STAGING_DIR)/$(UBOOT_ALTERA_STATING_TARGET)/generated
...
define UBOOT_ALTERA_INSTALL_STAGING_CMDS
	...
	cp -Rf $(@D)/bsp/generated/* $(UBOOT_ALTERA_STAGING_GENERATED)/
    mkdir -p $(UBOOT_ALTERA_STAGING_HANDOFF)
    cp -Rf $(UBOOT_ALTERA_QUARTUS_HANDOFF_DIR)/* $(UBOOT_ALTERA_STAGING_HANDOFF)/
endef
