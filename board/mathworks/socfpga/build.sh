...
COMMON_CONFIG=${CONFIG_DIR}/socfpga_common.defconfig
...
mkconfig() {
	...
	BOARD_CONFIG=${CONFIG_DIR}/socfpga_${BOARD}.defconfig
	OS_CONFIG=${CONFIG_DIR}/socfpga_${OPSYS}.defconfig
	TOOLCHAIN_CONFIG=${CONFIG_DIR}/socfpga_${TOOLCHAIN}.defconfig		
